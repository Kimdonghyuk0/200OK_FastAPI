...
async def generate_story(request: StoryRequest):
          ...
          messages=[
    {
        ...
        "content": (
            ...
            "`causeOfDeath`필드는 현재 상황이 사망할 상황이 아니어도 현재 상황과 연관되게 억지로 사망사유를 생성해줘"
            "- `content`: 현재 플레이어의 상황 설명"
            "- `choice1`, `choice2`, `choice3`: 플레이어가 선택할 수 있는 세 가지 선택지 텍스트"
            "- `water`: 현재 선택이 물에 미치는 변화량 (변화량 범위는: -1, 0, 1, 2).상황에 따라 물을 얻을 수도 있고, 잃을 수도 있고, 변화량이 없을 수도 있어."
            "- `food`: 현재 선택이 음식에 미치는 변화량 (변화량 범위는 : -1, 0, 1, 2)상황에 따라 음식을 얻을 수도 있고, 잃을 수도 있고, 변화량이 없을 수도 있어."
            "- `damage`: 현재 선택이 플레이어에게 입히는 피해(피해량 범위는 : 0 ~ 3)"
            "- `description`: 텍스트만보고 그림을 그릴 수 있게 현재 상황의 한 순간을 글로 표현,주어(주어는 무조건 남자로 한다.) 목적어 서술어가 무조건 있어야 한다. (예: 우주복을 입고 아마존의 풀숲에서 앉아서 휴식을 취하고 있는 한 남자. 뒤에는 남자가 탔던 우주선이 있다.) 예시를 똑같이 쓰지마. 배경은 항상 아마존으로 묘사해줘"
            "- `causeOfDeath`: 만약 현재 상황에서 사망한다면 어떤 사유로 사망하게 되는지 간단하게 설명. 문장의 끝은 무조건 '사망...'으로 끝나야하고 앞 단어들과 문맥상 자연스럽게 연결이 되어야해. 현재 상황과 연관이 있고 논리적으로 납득이 되는 사망사유여야한다. 사망 상황이 아니더라도, 현재 상황과 관련된 사망 원인을 반드시 포함해야한다. 사망사유는 잔인하지 않아야해.ex) 나무 밑에 있는 독버섯을 먹고 사망..., 맹수에게 공격당해 사망..., 내리막길에서 미끄러져 사망..., 독사에게 물려 사망..."
